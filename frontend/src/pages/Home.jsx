...
async function createRide() {
  ...
  return (
    <div className='h-screen relative overflow-hidden'>
      ...
      <LiveTracking />
        {/* <img className='h-full w-full object-cover' src="https://papers.co/wallpaper/papers.co-am67-worldmap-blue-dark-earth-view-art-34-iphone6-plus-wallpaper.jpg" alt="" /> */}
      </div>
